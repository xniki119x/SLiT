...
public class Materials {
    ...
    public static ToolMaterial BONE_BLOCK_SIDE = EnumHelper.addToolMaterial("slit:bone_block_material",                     1,64,3.0F,1.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.BONE_BLOCK)));
    ...
    public static ToolMaterial TNT_BOTTOM = EnumHelper.addToolMaterial("slit:tnt_material",                                 1,32,3.0F,1.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.TNT)));
