...
public class Materials {
    ...
    public static ToolMaterial BONE_BLOCK_SIDE = EnumHelper.addToolMaterial("slit:bone_block_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.BONE_BLOCK)));
    ...
    public static ToolMaterial CACTUS_TOP = EnumHelper.addToolMaterial("slit:cactus_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.CACTUS)));
    public static ToolMaterial CAKE_TOP = EnumHelper.addToolMaterial("slit:cake_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.CAKE)));
    public static ToolMaterial CHORUS_FLOWER = EnumHelper.addToolMaterial("slit:chorus_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.CHORUS_FLOWER)));
    ...
    public static ToolMaterial COAL_BLOCK = EnumHelper.addToolMaterial("slit:coal_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.COAL_BLOCK)));
    public static ToolMaterial COBBLESTONE_MOSSY = EnumHelper.addToolMaterial("slit:cobble_mossy_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.MOSSY_COBBLESTONE)));
    ...
    public static ToolMaterial HAY_BLOCK_TOP = EnumHelper.addToolMaterial("slit:hay_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.HAY_BLOCK)));
    ...
    public static ToolMaterial MELON_SIDE = EnumHelper.addToolMaterial("slit:melon_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.MELON_BLOCK)));
    public static ToolMaterial MUSHROOM_BLOCK_SKIN_BROWN = EnumHelper.addToolMaterial("slit:mushroom_block_brown_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.BROWN_MUSHROOM_BLOCK)));
    public static ToolMaterial MUSHROOM_BLOCK_SKIN_RED = EnumHelper.addToolMaterial("slit:mushroom_block_red_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.RED_MUSHROOM_BLOCK)));
    ...
    public static ToolMaterial NOTEBLOCK = EnumHelper.addToolMaterial("slit:note_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.NOTEBLOCK)));
    ...
    public static ToolMaterial PRISMARINE_DARK = EnumHelper.addToolMaterial("slit:prismarine_dark_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.PRISMARINE)));
    public static ToolMaterial PRISMARINE_ROUGH = EnumHelper.addToolMaterial("slit:prismarine_rough_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.PRISMARINE)));
    ...
    public static ToolMaterial PURPUR_BLOCK = EnumHelper.addToolMaterial("slit:purpur_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.PURPUR_BLOCK)));
    public static ToolMaterial QUARTZ_BLOCK_TOP = EnumHelper.addToolMaterial("slit:quartz_block_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.QUARTZ_BLOCK)));
    public static ToolMaterial REDSTONE_BLOCK = EnumHelper.addToolMaterial("slit:redstone_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.REDSTONE_BLOCK)));
    ...
    public static ToolMaterial RED_SAND = EnumHelper.addToolMaterial("slit:red_sand_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.SAND)));
    ...
    public static ToolMaterial STONE_ANDESITE = EnumHelper.addToolMaterial("slit:andesite_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.STONE)));
    public static ToolMaterial STONE_DIORITE = EnumHelper.addToolMaterial("slit:diorite_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.STONE)));
    public static ToolMaterial STONE_GRANITE = EnumHelper.addToolMaterial("slit:granite_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.STONE)));
    public static ToolMaterial TNT_BOTTOM = EnumHelper.addToolMaterial("slit:tnt_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.TNT)));
    public static ToolMaterial WOOL_COLORED_WHITE = EnumHelper.addToolMaterial("slit:wool_material",1,15,2.0F,2.0F,1).setRepairItem(new ItemStack(Item.getItemFromBlock(Blocks.WOOL)));
}